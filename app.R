...
# Define UI ----
ui <- dashboardPage(
  dashboardHeader(title = "Structural VAR"),
  ...
  dashboardBody(
    ...
    fluidRow(
      ...
      box(width = 3,
          ...
          sliderInput("select_horizon", h3("Time horizon (Quarters)"),
      ...
      box(width = 9,
          h4(textOutput("title")),
          plotOutput("plot"),
          p(textOutput("ci_description")),
          "Structural VAR model with long run restrictions. Replication of Blanchard, O. J., & Quah, D. (1989). The dynamic effects of aggregate demand and supply disturbances. American Economic Review, 79(4), 655-673.",
          br(), "Data source: ", tags$a(href="https://fred.stlouisfed.org/", "FRED")
      )
